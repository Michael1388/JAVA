//A list is extremely useful for storing the values of variables for later use.
// That said, making mistakes is also relatively easy with a list.

//There is a program that uses a list in the exercise template. Modify it so 
//that its execution always produces the error IndexOutOfBounds. The user should
// not have to give any inputs to the program (e.g. write something on the keyboard)
...
public class IoobProgram {
    ...
    public static void main(String[] args) {
        ...
        for (String line : lines) {
            lines.get(6);// throw out of bounds error by asking for an index that doesn't exist
            System.out.println();
        }
