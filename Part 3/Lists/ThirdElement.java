...
//the third value on the list is printed. Remember that programmers start 
//counting from zero! The program is allowed to malfunction if there are fewer 
//than three entries on the list, so you don't need to prepare for such an event at all.
